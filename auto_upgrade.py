...
UPGRADE_1 = 'sdcc_upgrade_tni:New_BRANCH_SAVE_AND_SHARE,10.20.4.81,10.20.4.4,10.20.4.70,all'
UPGRADE_11 = 'sdcc_upgrade_mbi:New_BRANCH_SAVE_AND_SHARE,10.20.4.132,10.20.4.4,all'
...
def run_update():
    with settings(host_string=env.hosts[0]):
        run('fab -f /root/automation_sdcc/fabfile.py auto_upgrade:' + UPGRADE_STRING_L )
        print '###########################################################'
